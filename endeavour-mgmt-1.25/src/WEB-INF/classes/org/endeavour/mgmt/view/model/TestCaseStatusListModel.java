...
public class TestCaseStatusListModel extends GridBoxModel {

	public static final String PASS = "Pass";
	public static final String FAIL = "Fail";

	public TestCaseStatusListModel() {
		super();
	...
	private List<Status> initializeStatuses() {
		List<Status> theStatus = new ArrayList<Status>();
		theStatus.add(new Status(0, IViewConstants.RB.getString("fail.lbl"), FAIL));
		theStatus.add(new Status(1, IViewConstants.RB.getString("pass.lbl"), PASS));
		return theStatus;
	}
